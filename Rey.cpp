...
void Rey::mover_izq(int casillas, int color) { //Izquierda de la pantalla, no del punto de vista del peon
	if (getColor() == 0 && casillas == 1 && tablero.esPosOcupadaPorNegra(getPosx(), getPosy() - casillas) == false) { //Esto funciona bien para controlar los limites del tablero 
...
void Rey::mover_abajo_dcha(int casillas, int color) {
	if (getColor() == 0 && casillas == 1 && tablero.esPosOcupadaPorNegra(getPosx() + casillas, getPosy() - casillas) == false) {
